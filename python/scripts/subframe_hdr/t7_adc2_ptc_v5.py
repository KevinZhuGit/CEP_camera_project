...
data_folders = { 1:['f1_65ms_0.48_3.6_60rows_ptc_v1_t6Exp000053Mask900/t6Exp000053Mask900','../f1_65ms_0.48_3.6.csv','f1'],
                 ...
                 3:['20220829_f1_65ms_0.48_3.6_60rows_ptc_v1_t6Exp000058Mask900/t6Exp000058Mask900','../f1_65ms_0.48_3.6.csv','f1']
                 }
...
if(REARRANGE_IMGS):
    ...
    def rearrange_img_mp(index_file):
        global k
        k = k+1
        save_file = os.path.join('../../image/{}'.format(current_data),'subimg_{:04d}.npz'.format(index_file))
        read_file = os.path.join('../../image/{}'.format(current_data),'subbyte_{:04d}.npy'.format(index_file))
...
if(CALCULATE_INTENSITY):
    ...
    def calculate_flux_mp(i):
        read_file     = os.path.join('../../image/{}'.format(current_data),  'subimg_{:04d}.npz'.format(i))
        save_file_npz = os.path.join('../../image/{}'.format(current_data),    'flux_{:04d}.npz'.format(i))
        save_file_png = os.path.join('../../image/{}'.format(current_data),'flux_log_{:04d}.png'.format(i))
